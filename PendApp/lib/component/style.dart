...
class colorStyle{
  ...
  static final primaryColor = Color.fromRGBO(17, 27, 60, 1);
  static final accentColor = Color(0xFF34F5B6);
  static final limColor = Color(0xFF21bfb3);
  static final blueColor = Color(0xFF1dcdfe);
  static final goldColors = Color(0xffd0993c);
...
//   static final background = Color(0xFF191B2A);
  // static final background = Color(0xFF111b3c);
